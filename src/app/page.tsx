...
export default function Home() {
  ...
  return (
    <>
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            <div className="bg-[#E8E2D9] p-6 rounded-lg shadow-md hover:shadow-lg transition-shadow">
              ...
              <Link href="/blog?category=ceza-hukuku" className="text-[#8B7D6B] hover:text-[#6B5F4F] font-medium inline-flex items-center">
                Detaylı Bilgi
            ...
            <div className="bg-[#E8E2D9] p-6 rounded-lg shadow-md hover:shadow-lg transition-shadow">
              ...
              <Link href="/blog?category=aile-hukuku" className="text-[#8B7D6B] hover:text-[#6B5F4F] font-medium inline-flex items-center">
                Detaylı Bilgi
                <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 ml-1" viewBox="0 0 20 20" fill="currentColor">
                  <path fillRule="evenodd" d="M10.293 5.293a1 1 0 011.414 0l4 4a1 1 0 010 1.414l-4 4a1 1 0 01-1.414-1.414L12.586 11H5a1 1 0 110-2h7.586l-2.293-2.293a1 1 0 010-1.414z" clipRule="evenodd" />
                </svg>
            ...
            <div className="bg-[#E8E2D9] p-6 rounded-lg shadow-md hover:shadow-lg transition-shadow">
              ...
              <Link href="/blog?category=is-hukuku" className="text-[#8B7D6B] hover:text-[#6B5F4F] font-medium inline-flex items-center">
                Detaylı Bilgi
                <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 ml-1" viewBox="0 0 20 20" fill="currentColor">
                  <path fillRule="evenodd" d="M10.293 5.293a1 1 0 011.414 0l4 4a1 1 0 010 1.414l-4 4a1 1 0 01-1.414-1.414L12.586 11H5a1 1 0 110-2h7.586l-2.293-2.293a1 1 0 010-1.414z" clipRule="evenodd" />
                </svg>
            ...
            <div className="bg-[#E8E2D9] p-6 rounded-lg shadow-md hover:shadow-lg transition-shadow">
              ...
              <Link href="/blog?category=ticaret-hukuku" className="text-[#8B7D6B] hover:text-[#6B5F4F] font-medium inline-flex items-center">
                Detaylı Bilgi
                <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 ml-1" viewBox="0 0 20 20" fill="currentColor">
                  <path fillRule="evenodd" d="M10.293 5.293a1 1 0 011.414 0l4 4a1 1 0 010 1.414l-4 4a1 1 0 01-1.414-1.414L12.586 11H5a1 1 0 110-2h7.586l-2.293-2.293a1 1 0 010-1.414z" clipRule="evenodd" />
                </svg>
          ...
          <div className="text-center mt-12">
            <Link href="/blog" className="bg-[#8B7D6B] hover:bg-[#6B5F4F] text-white px-6 py-3 rounded-md font-medium transition-colors inline-block">
              Tüm Hizmetlerimiz
            </Link>
          </div>
        </div>
      ...
      {/* About section */}
      <section className="py-12 sm:py-16 md:py-20 bg-[#E8E2D9]">
        <div className="container mx-auto px-4">
          <div className="max-w-6xl mx-auto">
            <div className="bg-[#E8E2D9] rounded-lg shadow-md overflow-hidden hover:shadow-lg transition-shadow duration-300">
              <div className="flex flex-col md:flex-row">
                ...
                <div className="relative w-full md:w-1/2 h-[250px] sm:h-[300px] md:h-[400px] md:rounded-l-lg overflow-hidden">
                  <Image
